...
COLUMNS = ['Croptop', 'Pencil Skirt', 'A-line', 'Miniskirt']
...
SEGMENTS = list(df['Blog Name'].unique())
...
def generate_bar_graph():
    segment_dict = dict(df['Blog Name'].value_counts())
...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            dcc.Graph(
                ...
                style={'width': '100%'},
                figure=generate_scatter_plot('Croptop', 'Pencil Skirt', 'Linear', 'Linear')
            )
    ...
    html.Div([
        html.Div([
            html.Div([
                html.Div([
                    html.Strong('Reviews', id='tweet-title', className='titles', style={'float': 'left'}),
                    html.Button([
                        'REFRESH'
            ...
            html.Div([
                html.Strong('Review Polarity', className='titles'),
                html.Div([
                    dcc.Graph(
