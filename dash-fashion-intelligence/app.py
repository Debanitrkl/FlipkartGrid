    ...
    return html.Div(
        ...
        children=[
            html.Div(
                id="banner-text",
                children=[
                    html.H5("Fashion Intelligence Dashboard"),
                    html.H6("Trend Analysis and Sales Reporting"),
                ],
            ),
            html.Div(
                id="banner-logo",
                children=[
                    ...
                    html.Img(id="logo", src=app.get_asset_url("TeamIgnitors.png")),
                ],
            ),
        ],
    )
        ...
        children=[
            dcc.Tabs(
                ...
                children=[
                    dcc.Tab(
                        id="Specs-tab",
                        label="Product Specific Enquiry",
                        value="tab1",
...
def build_tab_1():
    return [
        ...
        html.Div(
            ...
            children=html.P(
                "Use historical sales and customer behaviour to establish a benchmark, or set new values."
            ),
        ),
        html.Div(
            id="settings-menu",
            children=[
                html.Div(
                    ...
                    children=[
                        html.Label(id="metric-select-title", children="Select Apparel Category"),
                        html.Br(),
                        dcc.Dropdown(
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Div(
                        ...
                        This is a dashboard made by Team Ignitors for monitoring user behaviour and sales data to analyse the product trend. 

                        ###### What does this app shows

                        Click on buttons in `Categories` column to visualize details of measurement trendlines on the bottom panel.

                        The sparkline on top panel and control chart on bottom panel show process monitor using scraping data. 
                        The trend is updated every other second to simulate real-time measurements. when the product surge is more than usual(resulting in out of stock) it is cited as 'Out of Control(OOC)' and are marked in red
                        . 
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    generate_section_banner("Live Sales and Customer Behaviour"),
                    html.Div(
                        id="metric-div",
                        children=[
            ...
            html.Div(
                ...
                children=[
                    generate_section_banner("User Behaviour"),
                    generate_piechart(),
                ],
            ),
        ],
...
def generate_metric_list_header():
    return generate_metric_row(
        ...
        {"id": "m_header_1", "children": html.Div("Categories")},
        {"id": "m_header_2", "children": html.Div("Sample")},
        {"id": "m_header_3", "children": html.Div("Live_Sale")},
        {"id": "m_header_4", "children": html.Div("Rising%")},
        {"id": "m_header_5", "children": html.Div("%sales")},
        {"id": "m_header_6", "children": "TrendScale"},
    )
...
def build_chart_panel():
    return html.Div(
        ...
        className="twelve columns",
        children=[
            generate_section_banner("Live Sales Chart"),
            dcc.Graph(
        ...
        annotations=[
            {
                ...
                "xref": "paper",
                "yref": "y",
                "text": "Discarded:" + str(round(lcl, 3)),
                "showarrow": False,
                "font": {"color": "white"},
            },
            {
            ...
            },
            {
                ...
                "xref": "paper",
                "yref": "y",
                "text": "High_sales: " + str(round(usl, 3)),
                "showarrow": False,
                "font": {"color": "white"},
            },
            {
                ...
                "xref": "paper",
                "yref": "y",
                "text": "Low_sales: " + str(round(lsl, 3)),
                "showarrow": False,
                "font": {"color": "white"},
            },
            {
...
def show_current_specs(n_clicks, dd_select, store_data):
    if n_clicks > 0:
        ...
        new_df_dict = {
            "Specs": [
                "Sales During (March-July)",
                "Sales During (August - October)",
                "Sales During (November - February)",
                "Average Sales Through out the year",
            ],
            "Current Setup": [
                curr_col_data["usl"],
                curr_col_data["lsl"],
